...
public class seleniumSimples {
    ...
    public void setUp(){
        ...
        driver = new ChromeDriver(options); // Instancia o selenium para Chrome Driver como opções
    ...
    public void tearDown(){
        driver.quit(); // destroi o objeto do selenium no WebDriver 
    ...
    public void testarSelectBackdrop(){
        ...
        // Jeito mais Completo
        // Digitar usuário e a senha
        // Clicar no elemento antes de escrever
        WebElement username = driver.findElement(By.id("user-name")); // Controlou a caixa de texto
       ...
       // username.sendKeys(Keys.chord("standard_user")); // escreve na caixa (letra por letra)
        ...
        // Verifica se está presente do carrinho de compras
